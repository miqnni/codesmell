...
import SearchAndFilterGroup from "@/components/features/exercise-list/search-and-filter/SearchAndFilterGroup";
...
export default function Page() {
  ...
  const getData = useCallback(async (signal: AbortSignal) => {
    ...
    setIsError(false);
    try {
      const res = await fetch(`http://localhost:8080/api/quiz/short-list`, {
        signal,
      });
